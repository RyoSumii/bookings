...
import (
	...
	"github.com/RyoSumii/bookings/internal/driver"
	"github.com/RyoSumii/bookings/internal/forms"
	"github.com/RyoSumii/bookings/internal/helpers"
	"github.com/RyoSumii/bookings/internal/models"
	"github.com/RyoSumii/bookings/internal/render"
	"github.com/RyoSumii/bookings/internal/repository"
	"github.com/RyoSumii/bookings/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	htmlMessage := fmt.Sprintf(`
		<strong>Reservation Conformation</strong><br>
		Dear %s: <br>
...
//BookRoom takes URl parameters, builds a sessional variable, and takes user to res screen
...
// ShowLogin shoes the login screen
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// get all the reservations for the current room
