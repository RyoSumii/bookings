...
// GetReservationByID returns one reservaton by ID
...
// UpdateReservations updates a user in the database
...
func (m *postgresDBRepo) GetRestrictionsForRoomByDate(roomID int, start, end time.Time) ([]models.RoomRestriction, error) {
	...
	query := `
		select id, coalesce(reservation_id, 0), restriction_id, start_date, end_date
...
//InsertBlockForRoom inserts a room_restriction
...
//DeleteBlockByID inserts a room_restriction
